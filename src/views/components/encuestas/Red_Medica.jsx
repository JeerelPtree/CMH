...
function RedMedica({ form, setForm }) {
                ...
                <Row>
                    <Col xs={12} md={12}>
                        <Row>
                            ...
                            <Credencializacion form={form} handleChange={handleChange} />

                            <Quirurgicas form={form} handleChange={handleChange} />

                            <Clinicas form={form} handleChange={handleChange} />

                            <SoporteTerapeutico form={form} handleChange={handleChange} />

                            <Otras form={form} handleChange={handleChange} />
...
function Credencializacion(props) {
...
function SoporteTerapeutico(props) {
    const form = props.form
    const handleChange = props.handleChange
